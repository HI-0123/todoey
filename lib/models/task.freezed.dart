...
class _$TaskTearOff {
  ...
  _Task call({String id = '', String title = '', bool isDone = false}) {
    return _Task(
      id: id,
      title: title,
      isDone: isDone,
...
class _$_Task implements _Task {
  const _$_Task({this.id = '', this.title = '', this.isDone = false});
...
abstract class _Task implements Task {
  const factory _Task({String id, String title, bool isDone}) = _$_Task;
